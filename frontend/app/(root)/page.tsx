...
import { Brain, Calendar, ClipboardList, Activity, Users, ArrowDown, MapPin } from "lucide-react"
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        <p className="text-white/80 transition-all duration-300 group-hover:text-white">{description}</p>
      </div>
    </motion.div>
  )
}
...
const StatisticCard = ({ value, label, trend, delay }) => {
  return (
    ...
    >
      ...
      {trend && <div className={`text-sm ${trend.includes("+") ? "text-green-400" : "text-red-400"}`}>{trend}</div>}
    </motion.div>
  )
}
      ...
      <nav className="fixed top-0 z-40 w-full border-b border-white/10 bg-black/10 backdrop-blur-md">
        <div className="container mx-auto flex h-16 items-center justify-between px-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-semibold text-white">Apex Health</span>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <Button className="bg-[#e2ff81] text-black hover:bg-[#d4ff60]">Sign up for free</Button>
          </div>
        </div>
      </nav>
        ...
        <>
          ...
          <section className="container mx-auto px-4 pt-32 pb-20">
            ...
            >
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-tight">
                Your Journey To <span className="text-white">Better Health</span>
                <br />
                <span className="text-[#e2ff81]">Starts Here.</span>
              </h1>
              <p className="text-lg text-white/80 max-w-xl mx-auto">
                Empower your wellness journey with our comprehensive health platform. Track goals, join classes, and
          ...
          <section className="container mx-auto px-4 py-16">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <StatisticCard value="10k+" label="Active Users" trend="+15% this month" delay={3.2} />
              <StatisticCard value="500+" label="Wellness Classes" trend="+28% this quarter" delay={3.4} />
              <StatisticCard value="50k+" label="Goals Achieved" trend="+8% this week" delay={3.6} />
              <StatisticCard value="24/7" label="Community Support" delay={3.8} />
            </div>
          </section>
              ...
              >
                <div className="space-y-6">
                  ...
                  <p className="text-white/80">
                    Experience how Apex Health transforms your healthcare practice with our interactive demo.
                  </p>
                  <Button className="bg-[#e2ff81] text-black hover:bg-[#d4ff60]">Watch Demo</Button>
                </div>
                <div className="relative h-[300px] rounded-lg overflow-hidden">
                  ...
                  />
                  <Image src="/placeholder.svg" alt="Demo Preview" fill className="object-cover" />
                </div>
              </motion.div>
            </div>
          </section>
          ...
          <section className="container mx-auto px-4 py-20">
            ...
            >
              <h2 className="text-3xl font-bold text-white mb-4">Transforming Lives, One Step at a Time</h2>
              <p className="text-white/80 max-w-2xl mx-auto">
                Join thousands of individuals who have improved their health and well-being with our platform
              </p>
            </motion.div>
              ...
              {[
                {
                  ...
                  comment: "The yoga classes and community support have been life-changing. I've never felt better!",
                },
                {
                  name: "Michael C.",
                  role: "Fitness Newbie",
                  comment: "The personalized recommendations helped me start my fitness journey with confidence.",
                },
                {
                  name: "Emily W.",
                  role: "Busy Professional",
                  comment: "The habit reminders and quick meditation sessions keep me balanced throughout the day.",
                },
              ].map((testimonial, i) => (
                <motion.div
          ...
          <section className="container mx-auto px-4 py-20">
            ...
            >
              ...
              <div className="relative z-10 space-y-6">
                <h2 className="text-4xl font-bold text-white">Ready to Transform Your Health?</h2>
                <p className="text-white/80 max-w-2xl mx-auto">
                  Join our community of wellness enthusiasts and start your journey to a healthier, happier you.
                </p>
              ...
              {[
                {
                  ...
                  rating: "⭐⭐⭐⭐⭐",
                  comment: "The diet planning feature was a game-changer for me!",
                },
                {
                  name: "Sophia L.",
                ...
                },
                {
                  ...
                  rating: "⭐⭐⭐⭐½",
                  comment: "The training programs and community support were invaluable",
                },
                {
                  name: "Emma R.",
                  achievement: "Improved flexibility",
                  rating: "⭐⭐⭐⭐⭐",
                  comment: "Yoga classes helped me achieve my flexibility goals",
                },
                {
                  name: "James T.",
                  achievement: "Better sleep quality",
                  rating: "⭐⭐⭐⭐⭐",
                  comment: "Sleep tracking and bedtime routines made a huge difference",
                },
                {
                  name: "Olivia P.",
                  achievement: "Healthier eating habits",
                  rating: "⭐⭐⭐⭐½",
                  comment: "Nutritional insights helped me make better food choices",
                },
              ].map((feedback, i) => (
                <motion.div
                  key={feedback.name}
                ...
                >
                  <div className="text-white/90 font-medium">{feedback.name}</div>
                  <div className="text-[#e2ff81] text-sm mb-2">{feedback.achievement}</div>
